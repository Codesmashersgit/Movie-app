          ...
          mobileNavigation.map((nav, index) => {
            return (
              <NavLink
                ...
                to={nav.href}
                className={({ isActive }) =>
                  `px-4 flex h-full items-center justify-center flex-col ${isActive ? "text-white" : "text-neutral-400"} hover:text-white transition-colors duration-300`
                }
                aria-label={nav.lable}
              >
